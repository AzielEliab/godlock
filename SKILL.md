...
- COLD-MULTI-SHELF-1.0 (challenge only; NO-FAN; same level as corpus#96): https://godlock.uk/shelves — canonical https://www.azielcorpuslibrary.net/shelves. Plane A 5 surfaces / 2 radii. Plane B ALL-TARGETS codeberg + archive.org PASS https://archive.org/details/aziel-lockset-tip; Framagit url null; GitFlic CNS-GITFLIC-EMAIL; GitLab CNS-GITLAB-CF-LOOP; Zenodo CNS-ZENODO-IP-BAN doi null. Plane C attest SLOT. Cap-7 design_of + resolves_to_hub:false. REDLINE-2026-09-14. FoldLock cite-only not encryption. GET /v1/mesh never enables. Header-only tokens if any. Lamb Lens. Person @id https://www.azieleliab.com/#aziel.
