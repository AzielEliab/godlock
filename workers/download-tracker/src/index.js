...
<body>
  <h1>GodLock downloads</h1>
  <p>GodLock does not argue. It records, analyzes, hardens, and grows.</p>
  <p><strong>Hosted download:</strong> <a href="/download?asset=godlock-0.1.0.tar.gz">godlock-0.1.0.tar.gz</a></p>
