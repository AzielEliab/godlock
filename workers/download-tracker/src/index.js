...
<body>
  ...
  <div class="card">
    ...
    <a class="dl" href="/download?asset=godlock-0.1.0.tar.gz">Download godlock-0.1.0.tar.gz — ${n} counted</a>
    ...
    <p class="iso">Isolated counter: Worker <code>godlock-download-tracker</code>, project <code>godlock</code>. Not mixed with any other *Lock.</p>
...
export default {
  async fetch(request, env) {
    ...
    if (url.pathname === "/go" && request.method === "GET") {
      ...
      const asset = dims.asset || "godlock-0.1.0.tar.gz";
