...
function aiHowTo(base) {
  ...
  return {
    ...
    cursor_glama_mcp: [
      ...
      "Suite mesh (QNM-BUILD-1.0, default off; live|locked|isolated counts only; no Node Gate; no auto-heal): GET https://godlock.uk/runtime/v1/mesh and POST /runtime/v1/mesh/{join|heartbeat|enable|disable}",
