...
function aiHowTo(base) {
  ...
  return {
    ...
    cursor_glama_mcp: [
      ...
      "Suite mesh (default off): GET https://godlock.uk/runtime/v1/mesh and POST /runtime/v1/mesh/{join|heartbeat|enable|disable}",
