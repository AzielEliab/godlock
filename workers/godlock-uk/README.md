...
- `/software` full aziel-runtime catalog (27 engines + aziel-runtime / FragGate). Service-bind `AZIEL_RUNTIME` first, then HTTPS origin / library, then a snapshot fallback so the page never goes empty.
