...
export function helpDoc() {
  return [
    ...
    "## Steer",
    "",
    "Steer is the share of scored public challenges: intelligent design (Specified Fit / bio code+reader), multi-simulation, Big Bang / standard cosmology (physics ledger), Came from nothing (creatio ex nihilo / something-from-nothing), and undecided.",
    ...
    "Current confidence and residual uncertainty are a separate pair and sum to 100 (floor 33.3 · ceiling 99.7).",
