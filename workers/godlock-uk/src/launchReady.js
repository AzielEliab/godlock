...
export const LAUNCH_READY_NOTE =
  ...
  + ". Not . GodLock is a challenge stress-test product, not a VPN identity. "
...
export const LAUNCH_READY_HTML_NOTE =
  ...
  + "+ radios channel cites worker_hardware:false + suite pack /download. Not . "
...
export function launchReadiness() {
  return {
    ...
    suite_download_note: "One-click suite pack JSON (REAL catalog + FoldLock tip + mesh cite). Worker wasm / WireGuard / OpenVPN SLOT. Counted GET /download. Not .",
    : CLAIM_COMPLETE,
    glama: GLAMA_RUNTIME,
...
export function launchLlmsSection() {
  ...
  return "\n## Softwares + runtime launch readiness\n\n"
    ...
    + "Suite pack: " + SUITE_DOWNLOAD + " (also " + SUITE_DOWNLOAD_V1 + "). Not .\n"
