...
export function siteOpenApi() {
  return {
    ...
    paths: {
      ...
      "/count": { get: { operationId: "godlockUkCount", summary: "Public Nodes / Live Nodes / Uses / Receipts plus current_score, residual (those two sum to 100), and steer scales including came_from_nothing (Steer frames sum to 100)", responses: { "200": { description: "OK" } } } },
